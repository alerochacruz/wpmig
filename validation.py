...
if __name__ == "__main__":
    # Example: you would normally get these from the config module
    ...
    #     'port': 22,
    #     'username': 'vagrant',
    #     'key_path': './demo_keys/demo_ed25519'
    # }
    #
    # dest_config = {
    #     'host': '192.168.0.251',
    ...
    if success:
        ...
        logger.error("\n:x: Some validations failed. Please fix the issues before migrating.")
        sys.exit(1)
